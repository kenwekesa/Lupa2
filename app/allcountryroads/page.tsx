      ...
      <div>
        <div className="alldestinations-main flex flex-col items-center justify-center text-lg font-bold">
          <h1 className="alldestinations-white-main">
            Country Roads<span className="color-span-green"> Tours</span>
          </h1>
        </div>
        <Container>
          <div className="flex flex-col gap-1 pt-9">
          <p className="text-md text-neutral-600 leading-8 text-md w-full text-justify">Embark on unparalleled Country Roads tours with our prime selection. Curated by experts, these journeys bring sought-after destinations to your doorstep. From scenic routes to charming countryside vistas, immerse yourself in luxurious travels filled with natural wonders and cultural experiences. Enhance your journey with personalized excursions, redefining your travel expectations.</p>
          </div>
        </Container>
        <Container>
          <div className="py-6">
