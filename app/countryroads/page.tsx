...
const DestinationPage = async ({ searchParams, tourParams }: HotelPageProps) => {
  ...
  const tours = await getCountryRoadsListing({ ...tourParams, category: "Country Roads" });
  ...
  return (
    ...
    <div className="all-destinations-main-main flex flex-col items-center justify-center text-lg font-bold">
        <h1 className="color-h1-destinations-main">Country Roads <span className="color-span-green">Destinations</span></h1>
      ...
      <div className="grid-cols-page-s pt-6 pb-4 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-8">
        ...
        <div className="w-full text-center pt-8">
          <Link className="outline-main-btn px-4 hover:bg-slate-400 hover:text-green-400 hover:shadow-md" href="/allcountryroads">View country roads</Link>
        </div>
          </Container>
