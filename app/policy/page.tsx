...
const DestinationPage = async ({ searchParams, tourParams }: HotelPageProps) => {
  ...
  return (
    ...
    <div className="all-destinations-main flex flex-col items-center justify-center text-lg font-bold">
        <h1 className="color-h1-destinations-main">Our Privacy <span className="color-span-green">Policy</span></h1>
      </div>
      <Container>
  <div>
    ...
    <ul>
      ...
      <li><strong>Company</strong> (referred to as either the Company, We, Us or Our in this Agreement) refers to Devanca Tour.</li>
      ...
      <li><strong>Website</strong> refers to Devanca Tours, accessible from https://www.devancatour.com/</li>
    ...
    <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</p>
          <ul>
            ...
            <li>Cookies can be Persistent or Session Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on TermsFeed website article.</li>
            <li>We use both Session and Persistent Cookies for the purposes set out below:</li>
            <li><strong>Necessary / Essential Cookies</strong>Type: Session Cookies: Administered by: Us:</li>
            ...
            <li>Type: Persistent Cookies, Administered by: Us, Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</li>
            <li><strong>Functionality Cookies:</strong></li>
            <li>Type: Persistent Cookies, Administered by: Us, Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</li>
    ...
    <ul>
      <li>By email: <a href="mailto:devancatour@gmail.com">devancatour@gmail.com</a></li>
      <li>By visiting this page on our website: <a href="https://www.devancatour.com/">https://www.devancatour.com/</a></li>
    </ul>
  </div>
</Container>
    </div>
