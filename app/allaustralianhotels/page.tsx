...
import getAustralianHotelLisings from "../acts/getAustralianHotelsListings";
...
const HotelPage = async ({ searchParams }: HotelPageProps) => {
  ...
  const listings = await getAustralianHotelLisings({ ...searchParams, hotel: "hotel", continent: "australia"});
  // const isEmpty = true;
  ...
  return (
    ...
    <div className="european-hotel-main flex flex-col items-center justify-center text-lg font-bold">
        <h1 className="color-h1-white-main">Australian <span className="color-span-green">Hotels</span></h1>
