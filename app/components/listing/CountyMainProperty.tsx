...
const CountyMainProperty: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
          ...
          <div className="flex flex-col h-[40vh] w-full border-[1px] rounded-xl border-solid border-neutral-300 py-4 px-4">
           ...
           <div className="w-[32vw] main-image-small-spans">
            ...
            <div className="font-normal py-1 w-[30vw] main-image-small-spans-c-main text-neutral-800">
                <span className="font-normal">Property type:</span> <span className="font-light text-sm text-neutral-700">{ data.type}</span>
            </div>
...
export default CountyMainProperty