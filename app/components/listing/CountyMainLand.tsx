...
const CountyMainLand: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
      ...
      >
          <div className="flex flex-col h-[40vh] w-full border-[1px] rounded-xl border-solid border-neutral-300 py-4 px-4">
           ...
           <div className="w-[32vw] main-image-small-spans">
              <div className="text-lg py-1 w-[30vw] font-semibold main-image-small-spans-c-title">
                <span> {data.title} </span>
              </div>
              {/* <div className="font-normal py-0.5 w-[30vw] main-image-small-spans-c text-neutral-800">
                {data.category } form center of <span className="text-neutral-500 text-sm">{ data.town}</span>
              </div> */}
            <div>
             <span className="text-sm px-3 py-[4px] mb-[6px] border-neutral-300 border-solid border-2 text-neutral-700 rounded-lg">{data?.category }</span>            
              ...
              <div className="flex flex-row py-1 items-center gap-1">
                  <div>
            ...
            <div className="font-normal py-1 w-[30vw] main-image-small-spans-c-main text-neutral-800">
                <span className="font-normal">Land survey:</span> <span className="font-light text-sm text-neutral-700">{ data.type}</span>
            </div>
            <div className="font-normal py-1 w-[30vw] main-image-small-spans-c-main text-neutral-800">
                <span className="font-normal">Land title deed:</span> <span className="font-light text-sm text-neutral-700">{ data.titleDeed}</span>
            </div>
             {/* {data.amenities.slice(1,2).map((item, index) => (
                    <div key={index} className="font-normal flex gap-3 items-center py-1 w-[30vw] main-image-small-spans-c">
            ...
            <div className="font-normal flex gap-3 items-center py-1 w-[30vw] main-image-small-spans-c">
            ...
            <div className="flex flex-row items-center gap-1">
                ...
                <div>
                  <span className=" border-green-500 text-green-500 border-solid px-4 py-2 border-2 bg-white hover:bg-green-500 hover:text-white cursor-pointer text-md rounded-xl main-image-small-spans-c-btn" >View property</span>        
                </div>
            </div> 
