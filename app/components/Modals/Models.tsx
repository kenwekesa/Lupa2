...
const Models: React.FC<ModalProps> = ({
    isOpen,
    onClose,
    onSubmit,
    title,
                ...
                <div className="flex flex-col gap-4 w-full">
                  <div className="modal-main-button flex flex-row justify-between gap-4">
                    {secondaryAction && secondaryLabel && (
                      <p className="text-neutral-800 flex items-center w-full justify-center hover:bg-neutral-100 border-[1px] border-solid border-neutral-300 rounded-lg px-5 py-[6px] text-sm hover:shadow-md cursor-pointer" onClick={handleSecondaryAction}>Previous</p>
                    )}
                    <p className="text-neutral-800 flex items-center w-full justify-center hover:bg-neutral-100 border-[1px] border-solid border-neutral-300 rounded-lg px-5 py-[6px] text-sm hover:shadow-md cursor-pointer" onClick={handleSubmit}>Continue</p>
                  </div>
                </div>
                {footer}
              </div>
