...
export default function AllDestinationsPage({ tourParams }: IParams) {
  ...
  const getToursAndRender = async () => {
    const tours = await getTanzanianTours({ ...tourParams, country: "tanzania" });
      ...
      <div>
        <div className="alldestinations-main flex flex-col items-center justify-center text-lg font-bold">
          <h1 className="alldestinations-white-main">
            Prime Tanzanian<span className="color-span-green"> Tour Destinations</span>
          </h1>
        </div>
        <Container>
          <div className="flex flex-col gap-1 pt-9">
          <p className="text-md text-neutral-600 leading-8 text-md w-full text-justify">Embark on an extraordinary Tanzanian adventure with our expertly crafted tours. Explore iconic landscapes from the Serengeti to Mount Kilimanjaro. Encounter majestic wildlife and experience the thrill of safari. Immerse yourself in the cultural richness of Zanzibar&apos;s historic Stone Town and discover the ancient wonders of the Great Ruins of Kilwa Kisiwani. Let us guide you through Tanzania&apos;s diverse wonders for an unforgettable journey.</p>
          </div>
        </Container>
        <Container>
          <div className="py-6">
