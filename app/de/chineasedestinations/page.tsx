...
export default function AllDestinationsPage({ tourParams }: IParams) {
  ...
  const getToursAndRender = async () => {
    const tours = await getChinaTours({ ...tourParams, country: "china" });
      ...
      <div>
        <div className="alldestinations-main flex flex-col items-center justify-center text-lg font-bold">
          <h1 className="alldestinations-white-main">
            Prime Chinease<span className="color-span-green"> Tour Destinations</span>
          </h1>
        </div>
        <Container>
          <div className="flex flex-col gap-1 pt-9">
          <p className="text-md text-neutral-600 leading-8 text-md w-full text-justify">Embark on an extraordinary Chinese adventure with our expertly crafted tours. Explore iconic landscapes from the historic Great Wall to the bustling streets of Shanghai. Encounter rich history and culture in Beijing&apos;s ancient temples and charming traditional villages. Immerse yourself in the culinary delights of Sichuan cuisine and discover the modern wonders of the Shanghai skyline. Let us guide you through China&apos;s diverse wonders for an unforgettable journey.</p>
          </div>
        </Container>
        <Container>
          <div className="py-6">
