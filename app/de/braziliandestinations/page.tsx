...
export default function AllDestinationsPage({ tourParams }: IParams) {
  ...
  const getToursAndRender = async () => {
    const tours = await getBrazilTours({ ...tourParams, country: "brazil" });
      ...
      <div>
        <div className="alldestinations-main flex flex-col items-center justify-center text-lg font-bold">
          <h1 className="alldestinations-white-main">
            Prime Brazilian<span className="color-span-green"> Tour Destinations</span>
          </h1>
        </div>
        <Container>
          <div className="flex flex-col gap-1 pt-9">
          <p className="text-md text-neutral-600 leading-8 text-md w-full text-justify">Embark on an extraordinary Brazilian adventure with our expertly crafted tours. Explore iconic landscapes from the majestic Amazon Rainforest to the stunning beaches of Rio de Janeiro. Encounter rich history and culture in São Paulo&lsquo;s bustling streets and charming colonial towns. Immerse yourself in the culinary delights of Bahia and discover the natural wonders of Iguazu Falls. Let us guide you through Brazil&lsquo;s diverse wonders for an unforgettable journey.</p>
          </div>
        </Container>
        <Container>
          <div className="py-6">
